                                                 ...
                                                 <div className="w-full pt-4 flex gap-x-4 justify-start items-center">
                                                        ...
                                                        <a href={`https://www.linkedin.com/in/${settings && settings.value.linkedin}`} className="bg-secondary light:shadow-[2px_2px_8px_0px_#7a7a7a] light:bg-light-secondary size-10 rounded-full p-2 group hover:bg-primary transition-all">
                                                               <svg className="w-full h-full" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                                      ...
                                                                      <g>
                                                                             <path className="fill-white light:fill-light-tertiary group-hover:fill-black transition-all" d="M2.5 18h3V6.9h-3V18zM4 2c-1 0-1.8.8-1.8 1.8S3 5.6 4 5.6s1.8-.8 1.8-1.8S5 2 4 2zm6.6 6.6V6.9h-3V18h3v-5.7c0-3.2 4.1-3.4 4.1 0V18h3v-6.8c0-5.4-5.7-5.2-7.1-2.6z" />
                                                                      </g>
                                                               </svg>
                                                        </a>
                                                        {/* twitter */}
                                   ...
                                   <div className="w-full xl:w-8/12 text-start max-xl:order-1" dir="rtl">
                                          <form className="xl:pl-12 xl:pr-4 font-morabba space-y-8" action="" onSubmit={e => handleForm(e)}>
                                                 ...
                                                 <div className="flex flex-col md:flex-row gap-8">
                                                        <input type="text" required className="w-full bg-secondary light:bg-light-secondary light:text-light-tertiary rounded-full py-3 px-6" name="" placeholder="نام" onChange={e => setName(e.target.value)} />
                                                        <input type="email" required className="w-full bg-secondary light:bg-light-secondary light:text-light-tertiary rounded-full py-3 px-6" name="" placeholder="ایمیل" onChange={e => setEmail(e.target.value)} />
                                                 </div>
                                                 {/* subject */}
                                                 <div>
                                                        <input type="text" required className="w-full bg-secondary light:bg-light-secondary light:text-light-tertiary rounded-full py-3 px-6" name="" placeholder="موضوع" onChange={e => setSubject(e.target.value)} />
                                                 </div>
                                                 {/* message */}
                                                 <div>
                                                        <textarea rows="7" required className="w-full h-fit bg-secondary light:bg-light-secondary light:text-light-tertiary  rounded-[2rem] p-4 " name="" placeholder="متن پیام" onChange={e => setMessage(e.target.value)}></textarea>
                                                 </div>
                                                 {/* button */}
                                                        ...
                                                        <button ref={buttonSend} type="submit" className='w-42 h-[58px] border border-primary py-0 group rounded-full flex justify-start items-center relative ml-0 mr-auto'>
                                                               <div ref={buttonSendData} className="w-full h-full">
                                                                      <div className='size-14 bg-primary rounded-full group-hover:w-full transition-all flex items-center justify-start absolute z-1'>
                                                                             <ArrowForwardRoundedIcon className='mui-icon-arrow-right ms-4 text-tertiary' />
                                                                      </div>
                                                                      <h4 className='pr-10 pt-3.5 group-hover:text-secondary transition-all font-morabba-bold light:text-neutral-400 relative z-1'>ارسال پیام</h4>
                                                               </div>
